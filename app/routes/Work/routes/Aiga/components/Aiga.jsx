...
var finalDirection = require('../../../../../assets/img/work/aiga/finalized/poster.png');
var website = require('../../../../../assets/img/work/aiga/website/01.png');
var lifeStyle = {
				...
				<div className="case-study">
					...
					<section className="case-study-info">
						<div className="container-sm">
							<div className="grid-2 copy challenge">
								<h1>The Challenge</h1>
							...
							</div><div className="grid-2 copy solution">
								<h1>The Solution</h1>
							...
							<Tabs>
								...
								<TabPanel>
									<div className="grid-3">
										<img src={brandImg.geo.one} />
									</div>
									<div className="grid-3">
										<img src={brandImg.geo.two} />
									</div>
									<div className="grid-3">
										<img src={brandImg.geo.three} />
									</div>
								</TabPanel>
								<TabPanel>
									<div className="grid-3">
										<img src={brandImg.tools.one} />
									</div>
									<div className="grid-3">
										<img src={brandImg.tools.two} />
									</div>
									<div className="grid-3">
										<img src={brandImg.tools.three} />
									</div>
								</TabPanel>
								<TabPanel>
									<div className="grid-3">
										<img src={brandImg.midCentury.one} />
									</div>
									<div className="grid-3">
										<img src={brandImg.midCentury.two} />
									</div>
									<div className="grid-3">
										<img src={brandImg.midCentury.three} />
									</div>
								</TabPanel>
							</Tabs>
						</div>
					...
					<section className="final-direction">
						<div className="container-sm">
							...
							<img src={finalDirection} />
						</div>
					</section>
					<section className="lifestyle">
						<div className="container-sm">
							<img src={lifeStyle.one} />
...
Aiga.propTypes = { name: React.PropTypes.string };
Aiga.defaultProps = { name: 'aiga' };
