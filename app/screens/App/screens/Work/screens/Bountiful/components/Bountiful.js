...
class Bountiful extends Component {
	...
	render() {
		let img = {
			brand: require('../../../../../../../images/work/bountiful/branding/logo.png'),
			exploration: {
				one: require('../../../../../../../images/work/bountiful/exploration/01.png'),
				two: require('../../../../../../../images/work/bountiful/exploration/02.png'),
				three: require('../../../../../../../images/work/bountiful/exploration/03.png'),
				four: require('../../../../../../../images/work/bountiful/exploration/04.png')
			},
			lifestyle: require('../../../../../../../images/work/bountiful/lifestyle/lifestyle.jpg'),
			web: {
				web: require('../../../../../../../images/work/bountiful/web/web.png'),
				mobile: require('../../../../../../../images/work/bountiful/web/mobile.png')
			},
			seeMore: {
				one: require('../../../../../../../images/work/see-more/fluid.jpg'),
				two: require('../../../../../../../images/work/see-more/hive.jpg'),
				three: require('../../../../../../../images/work/see-more/just-family.jpg'),
				four: require('../../../../../../../images/work/see-more/nsac.jpg')
			}
		}
		return (
			<DocumentTitle title="Bountiful Dental | Underbelly Creative">
				<div className="case-study bountiful">
					...
					<SeeMore items={[
						{ url: "fluid", title: "Fluid", img: img.seeMore.one },
						{ url: "hive", title: "Hive", img: img.seeMore.two },
						{ url: "just-family", title: "Just Family", img: img.seeMore.three },
						{ url: "nsac", title: "North Seattle Alliance Church", img: img.seeMore.four }
					]}/>
				</div>
			</DocumentTitle>
		);
