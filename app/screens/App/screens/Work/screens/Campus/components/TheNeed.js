      ...
      <section className="the-need">
        <Excerpt
          ...
          excerpt={[
            ...
            "Enter 'The Campus'. The Campus connects students in the UAE with campus services across the country. The Underbelly team was intrigued when they approached us with their desire to create an app allowing students to easily search and compare information from universities such as tuition rates, events, and student discounts."
          ]}
        />
        <TagsContainer
          context="campus"
