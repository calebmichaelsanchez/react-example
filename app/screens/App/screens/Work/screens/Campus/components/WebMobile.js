...
class WebMobile extends Component {
  ...
  setPaddingTop() {
    ...
    let iconsContainer = document.querySelectorAll('.campus-icons__container');
    let iconsWrapper = document.querySelectorAll('.campus-icons__item');
    let iconsArray = [...icons];
    let iconsWrapperArray = [...iconsWrapper];
    let i;
    let w;
    let h;
    for (i = 0; i < iconsArray.length; i = i + 1) {
