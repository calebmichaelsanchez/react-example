...
class Traxion extends Component {
	...
	render() {
		let img = {
			award: require("../../../../../../../images/work/traxion/awards/traxion-award.png"),
			lifestyle: require("../../../../../../../images/work/traxion/lifestyle/lifestyle.jpg"),
			animation: {
				one: require('../../../../../../../images/work/traxion/animation/chart@2x.gif'),
				two: require('../../../../../../../images/work/traxion/animation/percent@2x.gif')
			},
			seeMore: {
				one:   	require("../../../../../../../images/work/see-more/aiga.jpg"),
				two: 		require("../../../../../../../images/work/see-more/fluid.jpg"),
				three:  require("../../../../../../../images/work/see-more/hive.jpg"),
				four:   require("../../../../../../../images/work/see-more/just-family.jpg")
			}
		}
		return (
			<DocumentTitle title="Traxion | Underbelly Creative">
				<div className="case-study traxion">
					...
					<SeeMore items={[
						{ url: "aiga", title: "AIGA Salt Lake City 100 Show", img: img.seeMore.one },
						{ url: "fluid", title: "Fluid", img: img.seeMore.two },
						{ url: "hive", title: "Hive", img: img.seeMore.three },
						{ url: "just-family", title: "Just Family", img: img.seeMore.four }
					]}/>
				</div>
			</DocumentTitle>
		);
