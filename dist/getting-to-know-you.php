...
//send confirmation email (or insert into database, etc...)
    ...
    $mission = Trim(stripslashes($_POST['mission']));
    $vision = Trim(stripslashes($_POST['vision']));
...
<main role="main" id="questionnaire-main">
    ...
    <div id="questionnaire-area" class="padding-xl">
        <form id="questionnaire-form" method="post" action="" data-abide>
            ...
            <div class="row">
              <div class="medium-12 columns">
                <label for="mission">What is your mission? (Why do you exist other than to make money?)</label>
                <textarea rows="10" name="mission" id="mission" class="input-tall"></textarea>
              </div>
            </div>

            <div class="row">
              <div class="medium-12 columns">
                <label for="vision">What is your vision? (What do you believe about the future? How will it help you achieve your mission?)</label>
                <textarea rows="10" name="vision" id="vision" class="input-tall"></textarea>
              </div>
            </div>
