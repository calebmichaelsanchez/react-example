...
<main role="main" id="questionnaire-main">
    ...
    <div id="questionnaire-area" class="padding-xl">
        <form id="questionnaire-form" method="post" action="" data-abide>
            ...
            <div class="row">
              <div class="medium-12 columns">
                <label for="mission">What is your mission?</label>
                <p class="muted small">
            ...
            <div class="row">
              <div class="medium-12 columns">
                <label for="vision">What is your vision?</label>
                <p class="muted small">
                    What do you believe about the future? How will it help you achieve your mission?
                </p>
