    ...
    */
    ...
    function get_stripe_payment_form_table( $form, $settings = array() ) {
        ...
        <div class="it-exchange-addon-settings it-exchange-stripe-addon-settings">
            ...
            <h4 class="hide-if-wizard"><?php _e( 'Optional: Checkout Image', 'it-l10n-exchange-addon-stripe' ); ?></h4>
            <p class="hide-if-wizard">
                <label for="stripe-checkout-image"><?php _e( 'Checkout Image', 'it-l10n-exchange-addon-stripe' ); ?> <span class="tip" title="<?php _e( 'This should be a square image (128x128 pixels) and will appear in the Stripe checkout', 'it-l10n-exchange-addon-stripe' ); ?>">i</span></label>
            ...
            <p class="hide-if-wizard">
                ...
                echo '<a href="' . $remove_image_url . '">' . __( 'Remove Checkout Image', 'it-l10n-exchange-addon-stripe' ) . '</a>';
                ?>
            </p>
            <?php } ?>
