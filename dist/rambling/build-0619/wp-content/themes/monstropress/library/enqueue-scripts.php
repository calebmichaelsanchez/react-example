...
if (!function_exists('FoundationPress_scripts')) :
  function FoundationPress_scripts() {
    ...
    wp_enqueue_script( 'jquery', get_template_directory_uri() . '/js/jquery/dist/jquery-1.11.1.min.js', array(), '1.0.0', false );
     wp_enqueue_script( 'jquery-migrate', get_template_directory_uri() . '/js/jquery/dist/jquery-migrate-1.2.1.min.js', array(), '1.0.0', false );
